  ...
  useEffect(() => {
    setRecommendedJobs([
      ...
      },
      {
        ...
        description: "Diagnoses and treats mental health disorders through talk therapy and behavioral interventions.",
        salary: "$85,000",
        growth: "10%",
        matchScore: 80,
      },
    
      {
        ...
        description: "Designs and oversees infrastructure projects like roads, buildings, and water systems.",
        salary: "$88,000",
        growth: "7%",
        matchScore: 70,
      },
      {
        ...
        description: "Researches and evaluates policy issues to inform government or organizational decisions.",
        salary: "$78,000",
        growth: "9%",
        matchScore: 85,
      },
      {
        ...
        description: "Conducts scientific studies to understand diseases and develop new treatments.",
        salary: "$95,000",
        growth: "11%",
        matchScore: 77,
      },
      {
        ...
        description: "Creates visual concepts to communicate ideas in digital and print formats.",
        salary: "$58,000",
        growth: "3%",
        matchScore: 85,
      },
      ...
      <div className="relative bg-gradient-to-br from-[#6d6bd3] via-[#6d6bd3] to-[#6d6bd3] h-[200px] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 relative h-full flex items-center justify-center">
          <div className="text-white text-center z-10">
            <h1 className="text-4xl font-bold leading-tight mb-4">Your Top 3 Career Matches</h1>
            ...
            .map((job, index) => (
              ...
              >
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600">{job.description || "Description not available"}</p>
                  {job.matchScore && (
                    <div className="mt-2">
