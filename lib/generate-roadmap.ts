...
export async function generateRoadmap(studentData: StudentData): Promise<RoadmapData> {
  try {
    ...
    return {
      ...
      years: {
        year1: {
          fall: {
            courses: [
              ...
              { code: "CMSC131", name: "Object-Oriented Programming I", credits: 4 },
              { code: "UNIV100", name: "First Year Experience", credits: 1 },
            ],
            opportunities: ["Join Computer Science Club", "Attend programming workshops"],
          ...
          spring: {
            courses: [
              { code: "CMSC132", name: "Object-Oriented Programming II", credits: 4 },
              ...
              { code: "PSYC100", name: "Introduction to Psychology", credits: 3 },
            ],
            opportunities: ["Participate in coding competitions", "Join study groups for CS courses"],
        ...
        year2: {
          fall: {
            courses: [
              { code: "CMSC216", name: "Introduction to Computer Systems", credits: 4 },
              { code: "CMSC330", name: "Organization of Programming Languages", credits: 3 },
              { code: "MATH240", name: "Linear Algebra", credits: 3 },
              { code: "STAT400", name: "Applied Probability and Statistics", credits: 3 },
              { code: "HIST200", name: "Technology in History", credits: 3 },
            ],
            opportunities: ["Undergraduate research assistant", "Hackathons participation"],
          ...
          spring: {
            courses: [
              ...
              { code: "CMSC320", name: "Introduction to Data Science", credits: 3 },
              { code: "CMSC335", name: "Web Application Development", credits: 3 },
              { code: "PHIL105", name: "Critical Thinking", credits: 3 },
              { code: "BSCI105", name: "Principles of Biology", credits: 4 },
            ],
            opportunities: ["Open source contributions", "Tech meetups and conferences"],
        ...
        year3: {
          fall: {
            courses: [
              ...
              { code: "CMSC421", name: "Introduction to Artificial Intelligence", credits: 3 },
              { code: "CMSC389", name: "Special Topics in Computer Science", credits: 3 },
              { code: "ARTT100", name: "Two-Dimensional Design Fundamentals", credits: 3 },
            ],
            opportunities: ["Study abroad in tech hub", "Teaching assistant position"],
          ...
          spring: {
            courses: [
              ...
              { code: "CMSC434", name: "Human-Computer Interaction", credits: 3 },
              { code: "CMSC436", name: "Programming Handheld Systems", credits: 3 },
              { code: "ECON200", name: "Principles of Microeconomics", credits: 3 },
            ],
            opportunities: ["Industry conference attendance", "Competitive programming team"],
        ...
        year4: {
          fall: {
            courses: [
              { code: "CMSC451", name: "Design and Analysis of Computer Algorithms", credits: 3 },
              { code: "CMSC411", name: "Computer Systems Architecture", credits: 3 },
              { code: "CMSC414", name: "Computer and Network Security", credits: 3 },
              { code: "CMSC435", name: "Software Engineering", credits: 3 },
              { code: "GVPT170", name: "American Government", credits: 3 },
            ],
            opportunities: ["Present research at symposium", "Lead a student tech project"],
          ...
          spring: {
            courses: [
              ...
              { code: "CMSC389E", name: "Ethics in Computer Science", credits: 1 },
            ],
            opportunities: ["Network with industry professionals", "Job fairs and interviews"],
      ...
      years: {
        year1: {
          fall: {
            ...
            opportunities: ["Join Business Students Association", "Attend entrepreneurship workshops"],
          ...
          spring: {
            courses: [
              { code: "ECON201", name: "Principles of Macroeconomics", credits: 3 },
              { code: "BMGT220", name: "Principles of Accounting I", credits: 3 },
              { code: "COMM107", name: "Oral Communication", credits: 3 },
              { code: "STAT100", name: "Elementary Statistics", credits: 3 },
              { code: "PSYC100", name: "Introduction to Psychology", credits: 3 },
            ],
            opportunities: ["Participate in business case competitions", "Join finance or marketing club"],
        ...
        year2: {
          fall: {
            courses: [
              { code: "BMGT221", name: "Principles of Accounting II", credits: 3 },
              { code: "BMGT230", name: "Business Statistics", credits: 3 },
              { code: "BMGT350", name: "Marketing Principles", credits: 3 },
              { code: "BMGT364", name: "Management and Organization", credits: 3 },
              { code: "PHIL140", name: "Business Ethics", credits: 3 },
            ],
            opportunities: ["Case competition participation", "Networking events with alumni"],
          ...
          spring: {
            courses: [
              ...
              { code: "BMGT301", name: "Introduction to Information Systems", credits: 3 },
              { code: "BMGT360", name: "Strategic Management", credits: 3 },
              { code: "HIST200", name: "Technology in History", credits: 3 },
            ],
            opportunities: ["Business leadership program", "Professional development workshops"],
        ...
        year3: {
          fall: {
            courses: [
              { code: "BMGT302", name: "Business Computer Application Programming", credits: 3 },
              { code: "BMGT332", name: "Operations Research for Management Decisions", credits: 3 },
              { code: "BMGT392", name: "Introduction to International Business", credits: 3 },
              { code: "BMGT385", name: "Operations Management", credits: 3 },
              { code: "COMM200", name: "Critical Thinking and Speaking", credits: 3 },
            ],
            opportunities: ["Study abroad in business hub", "Leadership role in business club"],
          ...
          spring: {
            courses: [
              ...
              { code: "BMGT372", name: "Introduction to Logistics and Supply Chain Management", credits: 3 },
              { code: "BMGT402", name: "Database Systems", credits: 3 },
              { code: "BMGT403", name: "Systems Analysis and Design", credits: 3 },
              { code: "ECON305", name: "Intermediate Macroeconomic Theory", credits: 3 },
            ],
            opportunities: ["Industry certification preparation", "Business plan competitions"],
        ...
        year4: {
          fall: {
            courses: [
              ...
              { code: "BMGT443", name: "Applied Equity Analysis and Portfolio Management", credits: 3 },
              { code: "BMGT484", name: "Electronic Marketing", credits: 3 },
              { code: "BMGT496", name: "Business Ethics and Society", credits: 3 },
              { code: "BMGT411", name: "Ethics and Professionalism in Accounting", credits: 3 },
            ],
            opportunities: ["Business plan competition", "Mentorship program with executives"],
          ...
          spring: {
            courses: [
              { code: "BMGT499", name: "Advanced Business Capstone", credits: 4 },
              { code: "BMGT468", name: "Special Topics in Management", credits: 3 },
              { code: "BMGT450", name: "Integrated Marketing Communications", credits: 3 },
              { code: "BMGT455", name: "Sales Management", credits: 3 },
              { code: "BMGT493", name: "Honors Study", credits: 1 },
            ],
            opportunities: ["Professional certification", "Job fairs and interviews"],
