          ...
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="flex items-center space-x-12">
              ...
              <div className="hidden md:flex space-x-8">
                ...
                <Link href="/resources" className="text-[#6d6bd3] hover:text-[#5a57c1] font-medium">
                  Resources
                </Link>
                <Link href="/success-stories" className="text-[#6d6bd3] hover:text-[#5a57c1] font-medium">
                  Success Stories
                </Link>
              </div>
            </div>
                ...
                {isProfileMenuOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl py-2 border border-gray-100">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-sm text-gray-500">john.anderson@example.com</p>
                    </div>
                    ...
                    <div className="border-t border-gray-100 mt-2">
                      <Link href="/logout" className="flex items-center px-4 py-3 text-red-600 hover:bg-gray-50">
