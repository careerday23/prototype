      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col space-y-1 md:space-y-0 md:flex-row md:justify-between md:items-center mt-4">
          <div className="flex flex-col text-right">
            <span className="text-gray-700 font-medium">Median Yearly Income:</span>
            <span className="text-gray-700">{income}</span>
          </div>

          <div className="flex flex-col text-right">
            <span className="text-gray-700 font-medium">Projected Job Growth:</span>
        ...
        <div className="flex justify-end mt-2">
          <Link href={`/roadmap/${id}`}>
            <Button className="bg-indigo-500 hover:bg-indigo-600">Learn More</Button>
          </Link>
        </div>
      </div>
    </div>
