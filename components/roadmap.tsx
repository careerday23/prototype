...
import { BookOpen, Briefcase, GraduationCap, Heart, Lightbulb, DollarSign, Award } from "lucide-react"
...
export function Roadmap({ data }: RoadmapProps) {
  ...
  return (
    ...
    <Card className="w-full">
      ...
      <CardContent>
        <Tabs defaultValue="year1" value={activeYear} onValueChange={setActiveYear}>
          ...
          {Object.entries(data.years).map(([yearKey, yearData]) => (
            <TabsContent key={yearKey} value={yearKey} className="space-y-8">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-semibold">Year {yearKey.replace("year", "")} Overview</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <SemesterCard title="Spring Semester" semesterData={yearData.spring} />
              </div>
            </TabsContent>
          ))}
        </Tabs>
