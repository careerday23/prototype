        ...
        setRoadmapData({
          ...
          years: {
            year1: {
              ...
              volunteerWork: ["Campus community service day", "Department-sponsored outreach program"],
              internships: ["Research assistant (on-campus)", "Entry-level summer internship"],
              projects: ["Introductory course project", "Personal portfolio development"],
            },
            year2: {
              courses: [
              ...
              opportunities: ["Apply for department scholarships", "Attend career fairs", "Join study groups"],
              volunteerWork: ["Peer tutoring", "Community organization related to field"],
              internships: ["Summer internship in related field", "Part-time job related to major"],
              projects: ["Team-based course project", "Independent study project"],
            },
            year3: {
              courses: [
              ...
              opportunities: ["Study abroad program", "Research with faculty", "Professional conference attendance"],
              volunteerWork: ["Leadership role in campus organization", "Industry-related volunteer work"],
              internships: ["Summer internship in target career field", "Co-op or part-time professional position"],
              projects: ["Research project", "Professional portfolio development"],
            },
            year4: {
              courses: [
                "Senior Seminar",
              ...
              volunteerWork: ["Mentor underclassmen", "Professional organization volunteer"],
              internships: ["Pre-professional internship", "Job shadowing in target career"],
              projects: ["Senior thesis or capstone project", "Industry-standard portfolio completion"],
            },
          },
        })
      }
